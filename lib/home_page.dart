...
List<Widget> DifferentFunctionPage = [
  ...
  Expanded(
    child: ListView(
      children: [
        Upcoming(group: 'personal', title: 'P+ 籃球會', descript: '領航員 vs 富邦勇士', 
          date1: '9:00 PM, FEB 2, 2023', date2: '11:00 PM, FEB 2, 2023'),
        SizedBox(height: 2,),
        Upcoming(group: 'flutter 讀書會', title: '例行性讀書會', descript: '討論 UI 設計與狀態儲存',
          date1: '9:00 PM, FEB2, 2023', date2: '11:00 PM, FEB 2, 2023')
      ],
    )
  ),
  Expanded(
    child: ListView(
      ...
      children: [
        Tracked(group: 'personal', title: '寒假規劃表進度', descript: '年後 ~ 開學的規劃進度',
          date1: '9:00 PM, FEB 2, 2023', date2: '11:00 PM, FEB 2, 2023', state: 0),
        SizedBox(height: 2,),
        Tracked(group: 'flutter 讀書會', title: '例行性讀書會', descript: '討論 UI 設計與狀態儲存',
          date1: '9:00 PM, FEB2, 2023', date2: '11:00 PM, FEB 2, 2023', state: 1)      
        ],
    )
  ),
  Expanded(
