...
class EventCardComponent {
  ...
  Widget getStartTimeBlock(EventSettingViewModel model, BuildContext context) {
    return _generateContentDisplayBlock(
        '開始時間',
        ElevatedButton(
            onPressed: () =>
                _showTimePicker(model.updateStartTime, context, model.startTime),
  ...
  Widget getEndTimeBlock(EventSettingViewModel model, BuildContext context) {
    return _generateContentDisplayBlock(
        '結束時間',
        ElevatedButton(
            onPressed: () =>
                _showTimePicker(model.updateEndTime, context, model.endTime),
            style: ElevatedButton.styleFrom(
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(5),
              ),
  ...
  Widget getContributorBlock(EventSettingViewModel model, BuildContext context) {
    return _generateContentDisplayBlock(
        '參與者',
        MaterialButton(
          onPressed: () async {
