...
class PersonalProfileTagSetting extends StatefulWidget {
  ...
  @override
  State<PersonalProfileTagSetting> createState() => _PersonalProfileTagSettingState();
}
...
class TagForm extends StatefulWidget {
  ...
  factory TagForm.edit(
          {required ProfileTag tag}) =>
      TagForm(mode: "edit", tag: tag);
  factory TagForm.create() => TagForm(
      mode: "create", tag: ProfileTag(tag: "", content: ""));
  @override
